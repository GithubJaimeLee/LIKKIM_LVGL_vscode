...
static void startup_quick_start_bg_cont(lv_obj_t* parent)
{
    ...
    lv_imagebutton_set_src(img_btn_create, LV_IMAGEBUTTON_STATE_PRESSED, &img_left_pressed_9797ff_14x26, &img_mid_pressed_9797ff_4x26, &img_right_pressed_9797ff_14x26);
